...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 16 15:55:14 2022
...
def registeration_based_movement(data, tmats= None,transformation_type = 'TRANSLATION' , 
    ...
    newseq , tr_mat = resgisteration_selextedIndex(data,mov_mat,  transformation_type= transformation_type,
                                 reference=reference)
    
    return newseq , tr_mat
#%%
